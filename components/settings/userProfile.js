      ...
      <View style={{flexDirection: 'column', height: 20}}>
            ...
            <View style={{ flexDirection: 'column', margin: 20, height: 250 }}>
                <View style={{ justifyContent: 'center', alignItems: 'center', marginBottom: 10 }}>
                    <Image
                        style={{ height: 120, width: 120, borderRadius: 60, borderWidth: 1, borderColor: "#FF5800" }}
                ...
                <View style={{ flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
                    {userInsights.map( insight => {
                        return(
                            <View key={insight[1]} style={{ margin: 10, flexDirection:"column", alignContent: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
                    <Button
                        ...
                        buttonStyle={{ backgroundColor: "white", borderWidth: 1, borderColor: '#FF5800', width: 150 }}
                    />
                </View>
            </View>
                ...
                <ScrollView>
                    <View style={{ flexDirection: 'column', margin: 5, height: 300 }}>
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10 }}>
                            <Text style={{ fontSize: 20, fontFamily: "Palatino Linotype" ,fontWeight: "bold" }}>All Recepies {'>'}</Text>
                        </View>
                    ...
                    <View style={{ margin: 20, justifyContent: 'center', alignItems: 'center', height: 200 }}>
                        <Button
                            title="Done"
