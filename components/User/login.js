...
import {
  Text, View, Image, Linking, TextInput, ScrollView, Alert
} from 'react-native';
  ...
  return (
    <ScrollView>
      <View style={{ flex: 1, flexDirection: 'column' }}>
          ...
          >
            {({
              ...
              && <Text style={{ fontSize: 10, color: 'red' }}>{errors.password}</Text>}
                <View style={{
                  flex: 1, marginTop: 50, justifyContent: 'flex-end', alignItems: 'center'
                }}
                >
        ...
        <View style={{
          flex: 1, justifyContent: 'flex-end', alignItems: 'center', marginTop: 20
        }}
        >
          ...
          <View style={{
            marginBottom: 10, width: 300, flexDirection: 'row', marginTop: 20
          }}
          >
        ...
        >
          <View>
            <Text>
              ...
              <Text
                style={{ color: '#FF5800', fontSize: 15, fontWeight: 'bold' }}
